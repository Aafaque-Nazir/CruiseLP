  ...
  return (
    <>
     <section id='destination' className="bg-gradient-to-b from-teal-300 to-blue-300 py-10">
      <h2 className="text-4xl font-bold text-black text-center mb-4">DESTINATIONS</h2>
      <p className="text-black text-center text-xl mb-8">Explore the world’s most stunning places</p>
